...
`)
	...
	commandTimeout := flag.Int("command-timeout", 60, "Maximum time in seconds to wait for a command to finish before force-killing it. Set to 0 to disable timeout.")
